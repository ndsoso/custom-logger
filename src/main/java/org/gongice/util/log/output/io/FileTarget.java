 ...
 * the LICENSE file.
 */
package org.gongice.util.log.output.io;

import org.gongice.util.log.format.Formatter;
 ...
 */
public class FileTarget extends  org.gongice.util.log.output.io.StreamTarget {
